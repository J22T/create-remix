...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create create-remix-8bc5
  fly apps create create-remix-8bc5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app create-remix-8bc5
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app create-remix-8bc5-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'create-remix-8bc5-staging' does not match app name in config file 'create-remix-8bc5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name create-remix-8bc5-db
  fly postgres attach --app create-remix-8bc5 create-remix-8bc5-db

  fly postgres create --name create-remix-8bc5-staging-db
  fly postgres attach --app create-remix-8bc5-staging create-remix-8bc5-staging-db
  ```
